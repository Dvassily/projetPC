...
$(DOBJ)n-threads-simulation-synchro-sem.o:$(DSRC)n-threads-simulation-synchro-sem.c $(DINC)n-threads-simulation-synchro-sem.h $(DINC)field.h
	...
	$(DOBJ)four-threads-simulation-synchro-monitor.o:$(DSRC)four-threads-simulation-synchro-monitor.c $(DINC)four-threads-simulation-synchro-monitor.h $(DINC)field.h
		$(CC) $(FLAGS) -c $< -o $@
